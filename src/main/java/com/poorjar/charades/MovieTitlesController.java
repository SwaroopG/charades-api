...
import com.poorjar.charades.dataaccess.MovieTitle;
import com.poorjar.charades.dataaccess.MovieTitlesRepository;
import com.poorjar.charades.exception.WordGameException;
import com.poorjar.charades.exception.WordGameExceptionResponse;
import com.poorjar.charades.importers.TeluguMovieTitlesImporter;
import com.poorjar.charades.importers.WikiMovieData;
...
public class MovieTitlesController extends ResponseEntityExceptionHandler {
    ...
    private List<MovieTitle> getMovieDataFromWiki(int year) throws Exception {
        ...
        for (WikiMovieData movie : wikiMovieData) {
            ...
            movieTitles.add(new MovieTitle(movie.getTitle(), movie.getDubTitle(), movie.getDirector(), movie.getCast(), year));
        }
        return movieTitles;
    }
